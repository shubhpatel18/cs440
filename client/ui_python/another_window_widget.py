...
class Ui_AnotherWindow(object):
    def setupUi(self, AnotherWindow):
        ...
        self.view_players.setColumnCount(14)
        ...
        self.available_players.setColumnCount(14)
    ...
    def retranslateUi(self, AnotherWindow):
        ...
        item = self.view_players.horizontalHeaderItem(0)
        ...
        item = self.available_players.horizontalHeaderItem(0)
        item.setText(_translate("AnotherWindow", "Position"))
