...
class Ui_AnotherWindow(object):
    def setupUi(self, AnotherWindow):
        ...
        self.gridLayout.addWidget(self.sacks_label, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.touchdowns_edit, 4, 1, 1, 1)
        self.fumbles_label = QtWidgets.QLabel(self.settings_tab)
        self.fumbles_label.setObjectName("fumbles_label")
        self.gridLayout.addWidget(self.fumbles_label, 4, 2, 1, 1)
        self.tlf_edit = QtWidgets.QLineEdit(self.settings_tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tlf_edit.sizePolicy().hasHeightForWidth())
        self.tlf_edit.setSizePolicy(sizePolicy)
        self.tlf_edit.setClearButtonEnabled(False)
        self.tlf_edit.setObjectName("tlf_edit")
        self.gridLayout.addWidget(self.tlf_edit, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.receptions_edit, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.fg_percentage_edit, 6, 3, 1, 1)
        self.punting_label = QtWidgets.QLabel(self.settings_tab)
        self.punting_label.setObjectName("punting_label")
        self.gridLayout.addWidget(self.punting_label, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.interceptions_edit, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.submit_button, 8, 0, 1, 4, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.turnovers_edit, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sacks_edit, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.punting_edit, 5, 3, 1, 1)
        self.yards_label = QtWidgets.QLabel(self.settings_tab)
        self.yards_label.setObjectName("yards_label")
        self.gridLayout.addWidget(self.yards_label, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.fg_percentage_label, 6, 2, 1, 1)
        self.turnovers_label = QtWidgets.QLabel(self.settings_tab)
        self.turnovers_label.setObjectName("turnovers_label")
        self.gridLayout.addWidget(self.turnovers_label, 5, 0, 1, 1)
        self.tlf_label = QtWidgets.QLabel(self.settings_tab)
        self.tlf_label.setObjectName("tlf_label")
        self.gridLayout.addWidget(self.tlf_label, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.receptions_label, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.yards_edit, 3, 1, 1, 1)
    ...
    def retranslateUi(self, AnotherWindow):
        ...
        self.tlf_label.setText(_translate("AnotherWindow", "Tackles for Loss:"))
