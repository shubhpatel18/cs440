...
class Ui_AnotherWindow(object):
    def setupUi(self, AnotherWindow):
        ...
        self.position_to_fill = QtWidgets.QComboBox(self.player_stats_tab)
        self.position_to_fill.setObjectName("position_to_fill")
        self.position_to_fill.addItem("")
        self.position_to_fill.addItem("")
        self.position_to_fill.addItem("")
        self.position_to_fill.addItem("")
        self.position_to_fill.addItem("")
        ...
        self.available_players_week_dropdown.addItem("")
        self.available_players_week_dropdown.addItem("")
        self.gridLayout_2.addWidget(self.available_players_week_dropdown, 0, 3, 1, 1)
    ...
    def retranslateUi(self, AnotherWindow):
        ...
        self.position_to_fill.setItemText(0, _translate("AnotherWindow", "qb"))
        self.position_to_fill.setItemText(1, _translate("AnotherWindow", "rb"))
        self.position_to_fill.setItemText(2, _translate("AnotherWindow", "wr1"))
        self.position_to_fill.setItemText(3, _translate("AnotherWindow", "wr2"))
        self.position_to_fill.setItemText(4, _translate("AnotherWindow", "te"))
        self.position_to_fill.setItemText(5, _translate("AnotherWindow", "flex"))
        self.position_to_fill.setItemText(6, _translate("AnotherWindow", "center"))
        self.position_to_fill.setItemText(7, _translate("AnotherWindow", "lg"))
        self.position_to_fill.setItemText(8, _translate("AnotherWindow", "rg"))
        self.position_to_fill.setItemText(9, _translate("AnotherWindow", "punter"))
        self.position_to_fill.setItemText(10, _translate("AnotherWindow", "de1"))
        self.position_to_fill.setItemText(11, _translate("AnotherWindow", "de2"))
        self.position_to_fill.setItemText(12, _translate("AnotherWindow", "lb1"))
        self.position_to_fill.setItemText(13, _translate("AnotherWindow", "lb2"))
        self.position_to_fill.setItemText(14, _translate("AnotherWindow", "lb3"))
        self.position_to_fill.setItemText(15, _translate("AnotherWindow", "cb1"))
        self.position_to_fill.setItemText(16, _translate("AnotherWindow", "cb2"))
        self.position_to_fill.setItemText(17, _translate("AnotherWindow", "s1"))
        self.position_to_fill.setItemText(18, _translate("AnotherWindow", "s2"))
        self.position_to_fill.setItemText(19, _translate("AnotherWindow", "kicker"))
