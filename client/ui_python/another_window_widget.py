...
class Ui_AnotherWindow(object):
    def setupUi(self, AnotherWindow):
        ...
        self.view_players.setColumnCount(18)
        ...
        self.label_2 = QtWidgets.QLabel(self.player_stats_tab)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_2.addWidget(self.label_2)
        self.count_spinbox = QtWidgets.QSpinBox(self.player_stats_tab)
        self.count_spinbox.setMaximum(10000)
        self.count_spinbox.setProperty("value", 100)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 277, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem1, 0, 4, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(20, 277, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem2, 0, 5, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(284, 108, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_4.addItem(spacerItem3, 1, 0, 5, 1)
        self.label_3 = QtWidgets.QLabel(self.profile_tab)
        self.label_3.setObjectName("label_3")
        self.gridLayout_4.addWidget(self.label_3, 1, 1, 1, 2)
        spacerItem4 = QtWidgets.QSpacerItem(218, 108, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_4.addItem(spacerItem4, 1, 3, 5, 2)
        self.label_4 = QtWidgets.QLabel(self.profile_tab)
        self.label_4.setObjectName("label_4")
        self.gridLayout_4.addWidget(self.label_4, 1, 5, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(284, 108, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_4.addItem(spacerItem5, 1, 6, 5, 1)
        self.profile_fantasy_team_dropdown = QtWidgets.QComboBox(self.profile_tab)
        self.profile_fantasy_team_dropdown.setObjectName("profile_fantasy_team_dropdown")
        self.gridLayout_4.addWidget(self.profile_fantasy_team_dropdown, 2, 1, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.profile_tab)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_4.addWidget(self.pushButton, 2, 5, 1, 1)
        self.edit_team = QtWidgets.QPushButton(self.profile_tab)
        self.edit_team.setObjectName("edit_team")
        self.gridLayout_4.addWidget(self.edit_team, 3, 1, 2, 1)
        self.remove_team = QtWidgets.QPushButton(self.profile_tab)
        self.remove_team.setObjectName("remove_team")
        self.gridLayout_4.addWidget(self.remove_team, 3, 2, 2, 1)
        self.signout = QtWidgets.QPushButton(self.profile_tab)
        self.signout.setObjectName("signout")
        self.gridLayout_4.addWidget(self.signout, 3, 5, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(20, 307, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem6, 4, 4, 3, 1)
        spacerItem7 = QtWidgets.QSpacerItem(20, 286, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem7, 5, 5, 2, 1)
        spacerItem8 = QtWidgets.QSpacerItem(20, 265, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem8, 6, 1, 1, 1)
        ...
        self.settings_success_label = QtWidgets.QLabel(self.settings_tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.settings_success_label.sizePolicy().hasHeightForWidth())
        self.settings_success_label.setSizePolicy(sizePolicy)
        self.settings_success_label.setText("")
        self.settings_success_label.setObjectName("settings_success_label")
        self.gridLayout.addWidget(self.settings_success_label, 10, 0, 1, 4, QtCore.Qt.AlignHCenter)
        ...
        AnotherWindow.setTabOrder(self.create_new_team, self.view_players_week_dropdown)
    ...
    def retranslateUi(self, AnotherWindow):
        ...
        item = self.view_players.horizontalHeaderItem(17)
        item.setText(_translate("AnotherWindow", "Projected Score"))
        self.view_players_week_dropdown.setItemText(0, _translate("AnotherWindow", "Week 14"))
        self.view_players_week_dropdown.setItemText(1, _translate("AnotherWindow", "Week 13"))
        self.view_players_week_dropdown.setItemText(2, _translate("AnotherWindow", "Week 12"))
        self.view_players_week_dropdown.setItemText(3, _translate("AnotherWindow", "Week 11"))
        self.view_players_week_dropdown.setItemText(4, _translate("AnotherWindow", "Week 10"))
        self.view_players_week_dropdown.setItemText(5, _translate("AnotherWindow", "Week 9"))
        self.view_players_week_dropdown.setItemText(6, _translate("AnotherWindow", "Week 8"))
        self.view_players_week_dropdown.setItemText(7, _translate("AnotherWindow", "Week 7"))
        self.view_players_week_dropdown.setItemText(8, _translate("AnotherWindow", "Week 6"))
        self.view_players_week_dropdown.setItemText(9, _translate("AnotherWindow", "Week 5"))
        self.view_players_week_dropdown.setItemText(10, _translate("AnotherWindow", "Week 4"))
        self.view_players_week_dropdown.setItemText(11, _translate("AnotherWindow", "Week 3"))
        self.view_players_week_dropdown.setItemText(12, _translate("AnotherWindow", "Week 2"))
        self.view_players_week_dropdown.setItemText(13, _translate("AnotherWindow", "Week 1"))
        ...
        self.available_players_week_dropdown.setCurrentText(_translate("AnotherWindow", "Week 14"))
        self.available_players_week_dropdown.setItemText(0, _translate("AnotherWindow", "Week 14"))
        self.available_players_week_dropdown.setItemText(1, _translate("AnotherWindow", "Week 13"))
        self.available_players_week_dropdown.setItemText(2, _translate("AnotherWindow", "Week 12"))
        self.available_players_week_dropdown.setItemText(3, _translate("AnotherWindow", "Week 11"))
        self.available_players_week_dropdown.setItemText(4, _translate("AnotherWindow", "Week 10"))
        self.available_players_week_dropdown.setItemText(5, _translate("AnotherWindow", "Week 9"))
        self.available_players_week_dropdown.setItemText(6, _translate("AnotherWindow", "Week 8"))
        self.available_players_week_dropdown.setItemText(7, _translate("AnotherWindow", "Week 7"))
        self.available_players_week_dropdown.setItemText(8, _translate("AnotherWindow", "Week 6"))
        self.available_players_week_dropdown.setItemText(9, _translate("AnotherWindow", "Week 5"))
        self.available_players_week_dropdown.setItemText(10, _translate("AnotherWindow", "Week 4"))
        self.available_players_week_dropdown.setItemText(11, _translate("AnotherWindow", "Week 3"))
        ...
        self.label_3.setText(_translate("AnotherWindow", "Fantasy Team Settings"))
        self.label_4.setText(_translate("AnotherWindow", "User Settings"))
        self.pushButton.setText(_translate("AnotherWindow", "Change Password"))
        self.edit_team.setText(_translate("AnotherWindow", "Edit Team Name"))
        self.remove_team.setText(_translate("AnotherWindow", "Delete Team"))
        self.signout.setText(_translate("AnotherWindow", "Sign Out"))
