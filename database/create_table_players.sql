...
(
	...
	"field_goal_percentage" integer NOT NULL DEFAULT 0,
	"injury_status" character varying(15) COLLATE pg_catalog."default" NOT NULL DEFAULT 'Healthy'::character varying,
